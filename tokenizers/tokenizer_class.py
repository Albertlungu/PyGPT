...
# def clean_text(text):
#     # Add any other patterns or characters you wish to remove
...
# root = tree.getroot()
# with open('/Users/albertlungu/Desktop/Personal VSCode/Python Chatbot/tokenizer_training_data/all_wiki_text.txt', 'w', encoding='utf-8') as f:
#     for elem in root.iter():
#         if elem.text and elem.text.strip():
#             cleaned = clean_text(elem.text.strip())
#             f.write(cleaned + '\n')
...
class BPETokenizer:
    def __init__(self, input=1000):
        ...
        """
        self.vocab_size = 32000 # int(np.sqrt(len(input)))
...
if __name__ == "__main__":
    input = open("tokenizer_training_data/all_wiki_text.txt", "r").read()
    # print(input)
