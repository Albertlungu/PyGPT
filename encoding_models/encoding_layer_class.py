...
class EmbeddingLayer:
    ...
    def _create_positional_encoding(self, n = 10000):
        ...
        """
        L = len(self.embeddings) # length of the embeddings inside the embedding layer
...
def main():
    ...
    embedding_layer = EmbeddingLayer(vocab_size=tokenizer.vocab_size, embedding_dim = 256, n=n)
